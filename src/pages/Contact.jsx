        ...
        <>
            <section className='mt-[50px] flex flex-col justify-center items-center space-y-10'>
                <div className='w-11/12 md:w-4/5 flex flex-col justify-center items-center space-y-4'>
                    <h1 className='uppercase text-3xl font-bold tracking-widest border-b border-orange-500'>Contact Us</h1>
                    ...
                    <div className='flex max-md:flex-col max-md:space-y-4 md:space-x-4'>
                        <div className='size-60 text-center rounded-xl bg-cardBg flex flex-col justify-center items-center space-y-4'>
                            <h3 className='flex items-center text-xl border-b border-orange-500'><HomeIcon />&nbsp;OFFICE</h3>
                            <p>315 93rd St Brooklyn, New York 11209, United States</p>
                        </div>
                        <div className='size-60 text-center rounded-xl bg-cardBg flex flex-col justify-center items-center space-y-4'>
                            <h3 className='flex items-center text-xl border-b border-orange-500'><PhoneIcon />&nbsp;CONTACT</h3>
                            <p><a href="tel:+1 987-654-321">+1 987-654-321</a></p>
                        </div>
                        <div className='size-60 text-center rounded-xl bg-cardBg flex flex-col justify-center items-center space-y-4'>
                            <h3 className='flex items-center text-xl border-b border-orange-500'><HomeIcon />&nbsp;EMAIL</h3>
